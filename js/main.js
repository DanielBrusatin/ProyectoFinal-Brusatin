...
const personaje = [
  ...
  " ____\n |   |\n O   |\n |   |\n     |\n     |\n   =====",
  " ____\n |   |\n O   |\n     |\n     |\n     |\n   =====",
  " ____\n |   |\n     |\n     |\n     |\n     |\n   ====="] // Array con los personajes segun la vida restante
...
function elegirPalabra() {
  ...
  palabraElegida.forEach(element => palabraAdivinada.push("_")); // Crea la palabra que se va formando con un guion por cada letra de la palabra elegida
  return
}
...
do {
  ...
  while(true){
    ...
    if (vidas == 0) {
      mostrarTablero();
      alert('Has perdido ' + nombre + '. La palabra era "' + palabraElegida.join("") + '".' );
      break;
    }
    if (aciertos == largoPalabra) {
      mostrarTablero();
      alert('Felicitaciones ' + nombre + ', has ganado!!! La palabra es "' + palabraElegida.join("") + '".' );
      break;
    }
  }
